...
many shareholders. In the graph view, St'astna Strnad v.o.s. neighbors another company with which it will 
share many future shareholders.
...
![task_03_merges_01.png](task_03_merges_01.png)
...
![task_03_merges_02.png](challenge_graphics/task_03_merges_02a.png)
...
![task_03_prochazka_01.png](challenge_graphics/task_03_prochazka_01.png)
To examine this company more closely, we reduce the neighborhood size to 2 and select only the suspicious company in the graph view.
...
To analyze the entire network in which SouthSeafood is located, we increase the neighborhood size to 9.
...
- people who work for several companies, such as Sanaa El-Amin, who works for the Stichting-Marine Company, which may indicate that the other companies she works for are also involved in illegal activities
